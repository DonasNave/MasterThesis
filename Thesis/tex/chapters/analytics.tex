...
Samotný proces nativní AOT a JIT kompilace je výrazně odlišný a výkonnostně náročný. Následující tabulka zobrazuje přehled časové náročnosti kompilace služeb pro oba kompilační cíle.
...
\tab{Čas kompilace služeb}{tab:priklad}{0.65}{|l|c|c|r|}{
  \hline
    & JIT (s) & AOT (s) & AOT \% zmenšení \\ \hline
  \emph{SRS} & 2 & 5 & 300 \\ \hline
  \emph{FUS} & 3 & 5 & 300 \\ \hline
  \emph{BPS} & 2 & 4 & 300 \\ \hline
  \emph{EPS} & 3 & 10 & 300 \\ \hline
}
...
\tab{Velikost obrazu služeb}{tab:priklad}{0.65}{|l|c|c|r|}{
  ...
  \emph{BPS} & 125.10 & 37.12 & 300 \\ \hline
  \emph{EPS} & 126.52 & 37.66 & 300 \\ \hline
}
