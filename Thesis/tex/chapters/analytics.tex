...
Výsledky ukázaly očekávané chování dle předchozích výsledků a hypotéz.
...
Výsledky ukázaly, že služba kompilovaná nativním AOT způsobem je rychleji dostupná a odpovídá na požadavky dříve, než služba kompilovaná pro .NET runtime. Oproti propagovaným zrychlení v dokumentaci .NET však nebylo dosaženo tak výrazného rozdílu. To je dáno režií kontejneru, tedy jeho OS. Výsledek je tedy závislý na konkrétním prostředí, ve kterém je služba spuštěna.
