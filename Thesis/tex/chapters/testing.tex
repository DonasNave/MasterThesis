...
\begin{itemize}
    ...
    \item \textbf{Hypotéza 2}: Kompilace AOT má za následek rychlejší spouštění, ale může vést k větším binárním velikostem ve srovnání s kompilací JIT.
    \item \textbf{Hypotéza 3}: Kompilace JIT poskytuje lepší optimalizaci výkonu za běhu díky své schopnosti přizpůsobit se skutečnému běhovému prostředí.
\end{itemize}
