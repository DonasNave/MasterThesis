...
\begin{itemize}
    ...
    \item \textbf{Vytváření metadat a manifestů} - Překladače .NET také vytvářejí metadata a soubory manifestů, které popisují obsah a závislosti sestav, což má zásadní význam pro verzování, zabezpečení a rozlišení sestav za běhu. \cite{netdocs} 
\end{itemize}
