...
\nastavklicovaslovacz{.NET, kompilace, služby, telemetrie, trimming, obraz, stack, metriky }
\nastavklicovaslovaen{.NET, compilation, services keywords, telemetry, trimming, image, stack, metrics }
...
\input{tex/chapters/recommendation.tex}
\input{tex/chapters/continuation.tex}
